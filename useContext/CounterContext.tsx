...
const reducer = (state: typeof StateType, action: ReducerAction): typeof StateType => {
  switch (action.type) {
...
const userCounterContext = (initState: StateType) => {
...
type UseCounterContextType = ReturnType <useCounterContext>
...
export const CounterProvider = ({
  ...
  return (
    <CounterContext.Provider value={useCounterContext(initState)}>{children} 
